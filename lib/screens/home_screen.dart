              ...
              Row(
                children: [
                  Container(
                    ...
                    child:
                        const Icon(Icons.grid_4x4, color: Palette.cyan, size: 28),
                  ),
            ...
            Row(
              children: [
                Container(
                  ...
                  child:
                      Icon(Icons.dashboard_outlined, color: accent, size: 24),
                ),
                const SizedBox(width: 14),
                Expanded(
                  child: Column(
